...
\usepackage{array} %permite alterar o espaçamento entre linhas de uma tabela
\newcolumntype{L}{>{\centering\arraybackslash}m{5.1cm}} %adiciona largura máxima para colunas de tabelas que sejam definidas por L
...
\hypersetup{
     	pagebackref=true,
		pdftitle={TCC - Guilherme Rocha Leite}, 
		pdfauthor={Guilherme Rocha Leite},
    	pdfsubject={\imprimirpreambulo},
	    pdfcreator={Guilherme Rocha Leite},
