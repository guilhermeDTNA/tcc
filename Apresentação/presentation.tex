...
\begin{frame}
    ...
    \begin{itemize}
     \item Impulsionar publicações e atrair apoiadores; %baixo nível de indexação do Google
     \item Gerenciar pessoas e arquivos digitais relacionadas à associação. %uma espécie de acervo digital e público
    \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Custo: Maior controle em função da rapidez em alterações; %vc mostra o cliente em partes, recebe um feedback mais rápido e aplica as alterações a serem apresentadas na próxima sprint
...
\begin{frame}
 ...
 %pag 41
    ...
    \begin{itemize}
        ...
        \item Maioria dos produtores de software aplicam o \textit{Scrum} como metodologia padrão \cite{begel2007usage};
...
% DESTACAR A DIFERENÇA NA SEGURANÇA E NA PERFORMANCE ENTRE OS DOIS
...
%         O container do MySQL fica mais seguro
% 
%         o processo de migração para outra VPS é muito mais fácil por causa dos comandos (inclusive pra pegar imagens que eu criei)
% 
%         Com docker a aplicação tem um desempenho melhor que em VMs porque eu consigo pegar uma imagem muito específica e adicionar só o que eu quero, além 
%         de que o Docker usar recursos (hardware e software) da própria máquina hospedeira, e na VM ela tem recursos próprios dela
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Vantagens: possui todos os atributos necessários a um banco de dados de grande porte \cite{milani2007mysql}, possui código aberto e de fácil aprendizagem e utilização. 
    \end{itemize}
