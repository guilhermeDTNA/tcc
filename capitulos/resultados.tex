...
Na presente seção estão as figuras demonstrativas do portal e do sistema gerencial. Por existirem diversas telas em ambos sistemas, só serão apresentadas as telas iniciais dos mesmos.

\textbf{Colocar a tela do portal}: A figura tal representa a página inicial do portal da Kuruatuba. ...

\textbf{Colocar a tela do sistema}: A tela inicial do sistema está representada na figura tal. Os dados de associados exibidos são completamente fictícios e exemplificam como  os dados reais estarão dispostos na tela para o usuário.
