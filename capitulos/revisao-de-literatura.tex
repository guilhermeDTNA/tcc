...
\textbf{\textit{Apache JMeter}}: ``é uma aplicação desktop projetada para a realização de testes de desempenho e estresse em aplicações cliente/servidor, tais como aplicações web ''.
