...
\begin{itemize}
 \item \textit{Scrum}
 \item \textit{Lean Software Development}
 \item Metodologia da família \textit{Crystal}
 \item \textit{Feature Driven Development} (FDD)
 \item \textit{Adaptive Software Development}
 \item \textit{Dynamic systems development method} (DSDM)
 \item \textit{Extreme programming} (XP)
\end{itemize}
...
\begin{figure}[htb]
 ...
 \includegraphics[scale=0.7]{figuras/agil-tradicional}
 
 \caption{Comparação entre as metodologias tradicionais e ágeis. Fonte: Adaptado de \cite{dos2013metodologias}}
 \label{tradicionais-ageis}
\end{figure}
