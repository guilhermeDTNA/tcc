...
\citeonline{sato2007uso} afirma que os métodos ágeis surgiram na década de 90 para alterar a mentalidade das equipes de desenvolvimento da época, contradizendo os métodos tradicionais eliminando gasto com documentação excessiva, enfatizando a comunicação e aumentando a proximidade com o cliente para produzir software de qualidade.
...
Concluindo o tema, é aconselhável exibir as diferenças entre os dois tipos de metodologias, para isso a tabela \ref{metodologias} foi criada. 
\newpage

\begin{table}[]
\label{metodologias}
\scalefont{0.5}
\caption{Diferenças básicas entre as metodologias tradicionais e ágeis. Fonte: Adaptado de \citeonline{dos2013metodologias}}
\centering
\begin{tabular}{|l|c|c|}
\hline
\multicolumn{1}{|c|}{\textbf{Características}}                    & \textbf{Gerenciamento Tradicional}                                                                         & \textbf{Gerenciamento Ágil}                                                                                                                                                       \\ \hline
Ter definido a priori                                             & Escopo                                                                                                     & Tempo (\textit{sprints})                                                                                                                                                                   \\ \hline
Responsável pela organização para atingir os objetivos do projeto & Gerente de projeto                                                                                         & \textit{Scrum master}                                                                                                                                                             \\ \hline
Frequência de reuniões de status                                  & \begin{tabular}[c]{@{}c@{}}Dependendo da complexidade/necessidade do projeto\end{tabular}               & Diárias                                                                                                                                                                           \\ \hline
Escopo                                                            & Bem definido nas fases iniciais do projeto                                                                 & \begin{tabular}[c]{@{}c@{}}Definido em alto nível e os requisitos\\  são priorizados e definidos de forma\\ iterativa. Necessita de maior controle\\ de planejamento\end{tabular} \\ \hline
Tempo                                                             & \begin{tabular}[c]{@{}c@{}}Cronograma detalhado para realização\\ de todo o projeto\end{tabular}           & \begin{tabular}[c]{@{}c@{}}Cronograma orientado a produto com\\ entregas incrementais de 2-4 semanas\end{tabular}                                                                 \\ \hline
Custo                                                             & \begin{tabular}[c]{@{}c@{}}Monitoração das alterações para que não\\ altere o custo planejado\end{tabular} & \begin{tabular}[c]{@{}c@{}}Maior controle em função da rapidez\\ na incorporação de alterações\end{tabular}                                                                       \\ \hline
Qualidade                                                         & \begin{tabular}[c]{@{}c@{}}Processo de verificação, validação e plano\\ de testes\end{tabular}             & \begin{tabular}[c]{@{}c@{}}Programação em pares, testes incrementais\\ e refatoração\end{tabular}                                                                                 \\ \hline
Riscos                                                            & \begin{tabular}[c]{@{}c@{}}Análise de riscos durante todo o ciclo de \\ vida do projeto\end{tabular}       & \begin{tabular}[c]{@{}c@{}}Aplica-se o mesmo conceito do gerenciamento\\ tradicional\end{tabular}                                                                                 \\ \hline
Comunicação                                                       & Documentação e formal                                                                                      & Implícita, interpessoal e colaborativa                                                                                                                                            \\ \hline
\end{tabular}
\end{table}
