...
Concluindo o tema, é aconselhável exibir as diferenças entre os dois tipos de metodologias, para isso as tabelas \ref{metodologia-tradicional} e \ref{metodologia-agil} foram criadas. 
\newpage
...
Posi{\c c}{\~a}o & País & IDH \\ % Note a separação de col. e a quebra de linhas
\hline                               % para uma linha horizontal
1 & Noruega        & .955 \\
2 & Austr{\'a}lia  & .938 \\
3 & EUA            & .937 \\
