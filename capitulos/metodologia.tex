...
\textit{Sprint 3} & Alteração de endereço IP (Protocolo da Internet) de imagens nos sistemas & 3 & 4  \\
...
\textbf{\textit{Sprint 3}}: como a \textit{sprint} 1 foi efetuada em ambiente local, as imagens destinadas à logo da Kuruatuba presente no cabeçalho, aos \textit{banners} rotatórios da página inicial e ao \textit{favicon} tiveram seus endereços IP associados ao ambiente de rede da máquina pessoal, e não da VPS. Portanto foi necessário alterar o caminho de cada uma delas para que fossem exibidas corretamente nos sistemas.

O prazo de 3 dias foi considerado o suficiente para execução das tarefas do ciclo atual tendo visto o seu baixo grau de complexidade, e o grau 3 de prioridade se justifica pela ausência de urgência na realização das atividades. 
